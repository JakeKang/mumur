import { db } from "@/shared/lib/server/db";
import { createQueryAdapter, type QueryAdapter } from "@/shared/lib/server/query-adapter";
import { createPostgresQueryAdapter, type PostgresQueryAdapter } from "@/shared/lib/server/query-adapter-pg";
import { getPostgresPool, isPostgresConfigured } from "@/shared/lib/server/postgres-client";
